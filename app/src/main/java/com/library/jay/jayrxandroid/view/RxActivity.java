...
public final class RxActivity {
    private static Map<String, PublishSubject<ActivityResult>> map = Maps.newHashMap();

    public RxActivity() {
    }

    public static Observable<ActivityResult> startActivityForResult(Activity activity, Intent intent, int requestCode) {
